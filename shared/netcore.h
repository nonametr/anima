...
#define SOCKET_MAX_COUNT 16384	    /// This number dont need to be too big, otherwise you're gonna be eating
                                    /// memory. 16384 = 64KB, so thats no big issue for now, and I really can't
...
private:
    ...
    Socket * _listen_sock[SOCKET_MAX_COUNT];
};
